...
c
     ...
     1            ifdipole,dipstr,dipvec,ifpgh,pot,grad,hess,
...
c
     ...
     1    call dreorderf(2*nd,ns,charge,chargesort,itree(ipointer(5)))
      if(ifdipole.eq.1) then
         ...
         call dreorderf(2*nd,ns,dipvec,dipvecsort,itree(ipointer(5)))
      endif
...
c
      call h2dmpalloc(nd,itree(ipointer(1)),iaddr,nlevels,lmptot,
     1    nterms)
...
c
      ...
      if(ifpgh.eq.2) then
        call dreorderi(2*nd,ns,potsort,pot,itree(ipointer(5)))
        call dreorderi(4*nd,ns,gradsort,grad,itree(ipointer(5)))
      endif

      if(ifpgh.eq.3) then
        call dreorderi(2*nd,ns,potsort,pot,itree(ipointer(5)))
        call dreorderi(4*nd,ns,gradsort,grad,itree(ipointer(5)))
        call dreorderi(6*nd,ns,hesssort,hess,itree(ipointer(5)))
      endif
...
cc      stop
      ...
      if(ifpghtarg.eq.2) then
        call dreorderi(2*nd,nt,pottargsort,pottarg,itree(ipointer(6)))
        call dreorderi(4*nd,nt,gradtargsort,gradtarg,itree(ipointer(6)))
      endif

      if(ifpghtarg.eq.3) then
        call dreorderi(2*nd,nt,pottargsort,pottarg,itree(ipointer(6)))
        call dreorderi(4*nd,nt,gradtargsort,gradtarg,itree(ipointer(6)))
        call dreorderi(6*nd,nt,hesstargsort,hesstarg,itree(ipointer(6)))
      endif
