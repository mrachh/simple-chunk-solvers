      subroutine helm2d_comb_dir_matc(k,nch,n,srcvals,srccoefs,zpars,
     1   xmat)
c
c--------------
...
c  
      implicit none
      integer k,nch,n
      complex *16 srcvals(8,k,nch),srccoefs(6,k,nch)
      complex *16 zpars(3),xmat(n,n)
      real *8 dpars
      integer ipars
      external h2d_combc

      call zgetmat_bdryc(k,nch,n,srcvals,srccoefs,h2d_combc,8,0,
...
c
c
      subroutine helm2d_dielec_matc(k,nch,n,srcvals,srccoefs,zpars,
...
c  
      ...
      external h2d_transmission_dirc
      external h2d_transmission_neuc
c
      allocate(xmatij(n,n))
      zsend(1) = zpars(1)
      zsend(2) = zpars(4)
...
c
      ...
      call zgetmat_bdryc(k,nch,n,srcvals,srccoefs,h2d_transmission_dirc,
...
c
      ...
      zsend(5) = 0.0d0
      zsend(6) = 0.0d0
      call zgetmat_bdryc(k,nch,n,srcvals,srccoefs,h2d_transmission_neuc,
     1  8,0,dpars,6,zsend,0,ipars,xmatij)
c
ccc      call prin2(' xmatij = *',xmatij,2*n*n)
      do i = 1,n
...
c
c
      subroutine helm2d_dielec_mat_nregc(k,nch,n,srcvals,srccoefs,zks,
     1   alphas,betas,nregion,iregionl,iregionr,xmat)
c
c     This subroutine generates the matrix corresponding to the 
c     dielectric interface problem.
c     Unknowns are ordered by blocks corresponding to sigma/mu densities
...
c  
      implicit none
      integer k,nch,n,i,j,nregion,ibl
      complex *16 srcvals(8,k,nch),srccoefs(6,k,nch)
      complex *16 zks(0:nregion)
      complex *16 alphas(0:nregion)
      complex *16 betas(0:nregion)
      complex *16 xmat(2*n,2*n)
      real *8 dpars
      integer ipars
      integer iregionl(nch)
...
c
      call prinf(' doing 11 block *',nch,0)
      ibl = 1
      call zgetmat_bdryc_nreg(k,nch,n,srcvals,srccoefs,
     1  h2d_transmission_dirc,8,0,dpars,zks,alphas,betas,nregion,
     2  iregionl,iregionr,ibl,0,ipars,xmatij)
c
ccc      call prin2(' xmatij = *',xmatij,2*n*n)
      do i = 1,n
      do j = 1,n
...
c
      ...
      ibl = 3
      call zgetmat_bdryc_nreg(k,nch,n,srcvals,srccoefs,
     1  h2d_transmission_neuc,8,0,dpars,zks,alphas,betas,nregion,
     2  iregionl,iregionr,ibl,0,ipars,xmatij)
c
ccc      call prin2(' xmatij = *',xmatij,2*n*n)
      do i = 1,n
