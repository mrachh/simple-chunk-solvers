...
c
c
      subroutine helm2d_dielec_mat_nreg(k,nch,n,srcvals,srccoefs,zks,
...
c
      call prinf(' doing 11 block *',nch,0)
      ibl = 1
      call zgetmat_bdry_nreg(k,nch,n,srcvals,srccoefs,
     1  h2d_transmission_dir,8,0,dpars,zks,alphas,betas,nregion,
...
c
      ...
      ibl = 3
      call zgetmat_bdry_nreg(k,nch,n,srcvals,srccoefs,
     1  h2d_transmission_neu,8,0,dpars,zks,alphas,betas,nregion,
     2  iregionl,iregionr,ibl,0,ipars,xmatij)
c
ccc      call prin2(' xmatij = *',xmatij,2*n*n)
      do i = 1,n
