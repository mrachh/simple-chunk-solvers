      subroutine h2d_slpc(srcinfo,ndt,targinfo,ndd,dpars,ndz,zk,ndi,
     1   ipars,u)
c
...
c
      ...
      integer ipars
      real *8 dpars
      complex *16 srcinfo(2),targinfo(ndt)
      complex *16 u,h0,ima,zs,z,zk,h1,rr2,rr
...
c
c
      subroutine h2d_sprimec(srcinfo,ndt,targinfo,ndd,dpars,ndz,zk,
     1   ndi,ipars,u)
      implicit real *8 (a-h,o-z)
      integer ipars
      real *8 dpars
      complex *16 srcinfo(2),targinfo(ndt)
      complex *16 u,h0,ima,zs,z,zk,h1,gx,gy,ztmp,rr2,rinv,rr
      data ima/(0.0d0,1.0d0)/
      data zs/(0.0d0,0.25d0)/
...
c
c
      subroutine h2d_dlpc(srcinfo,ndt,targinfo,ndd,dpars,ndz,zk,
     1   ndi,ipars,u)
      implicit real *8 (a-h,o-z)
      integer ipars
      real *8 dpars
      complex *16 srcinfo(8),targinfo(2)
      complex *16 u,h0,ima,zs,z,zk,h1,gx,gy,ztmp,rr2,rinv,rr
      data ima/(0.0d0,1.0d0)/
      data zs/(0.0d0,0.25d0)/
...
c
c
      subroutine h2d_combc(srcinfo,ndt,targinfo,ndd,dpars,ndz,zpars,
     1   ndi,ipars,u)
      implicit real *8 (a-h,o-z)
      integer ipars
      real *8 dpars
      complex *16 srcinfo(8),targinfo(ndt)
      complex *16 zpars(3),u,h0,ima,zs,z,zk,h1,gx,gy,ztmp,rr2,rinv,rr
      data ima/(0.0d0,1.0d0)/
      data zs/(0.0d0,0.25d0)/
...
c
c
      subroutine h2d_transmission_dirc(srcinfo,ndt,targinfo,ndd,dpars,
...
c
c
      subroutine h2d_transmission_neuc(srcinfo,ndt,targinfo,ndd,dpars,
     1   ndz,zpars,ndi,ipars,u)
c
c
c         The kernel of interaction is given by
...
c
c
      subroutine l2d_dlpc(srcinfo,ndt,targinfo,ndd,dpars,ndz,zk,
     1   ndi,ipars,u)
      implicit real *8 (a-h,o-z)
      integer ipars
      real *8 pi,dpars
      ...
      complex *16 xdiff,ydiff
      complex *16 dipstr
      data ima/(0.0d0,1.0d0)/

      dipstr = srcinfo(7) + ima*srcinfo(8)
